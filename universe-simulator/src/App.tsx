...
const LAWS: [string, string][] = [
  ...
  ['SUSTAINABILITY & PERSISTENCE', 'Each particle is associated with a persistence metric that decays in the absence of interaction. Configurations that fail to maintain sufficient persistence become dynamically unstable and are removed from the simulated state space.'],
  ['INFORMATION PROPAGATION', 'Physical interactions act as channels of information exchange, reinforcing the persistence of participating entities. Systems that fail to exchange information with their environment progressively lose stability.'],
