...
const LAWS: [string, string][] = [
  ...
  ['STRUCTURAL FEEDBACK', 'High-density regions generate "Entropy Particles" (red) that actively drain persistence from local entities. This negative feedback loop prevents infinite collapse and enforces structural limits.'],
