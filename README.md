...
O README agora está **100% alinhado com a v13.2**, incluindo:
- Persistência cross-sessão
- Trade-off de observação ativa
- Auto-regulação (BHs + Λ)
- ER:EPR / memória
- Estados observados (tick 300 / tick 9922)
- Gênese contínua
- Sumário atualizado com| **[POTENCIAL]** | Hipótese testável. Não provada. |
| **[LATENTE]** | Direção plausível. Requer investigação formal. |
