...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Em vez de mudar instantaneamente, podemos apenas ajustar o comportamento
    // sem forçar o fechamento da observação, apenas reduzindo a carga visual.
  }, [documentaryMode]);
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLCanvasElement>) => {
    ...
    // Telescópio Cósmico: Observar localmente removido para evitar influência contínua
  };
  ...
  const handleCanvasClick = (e: React.MouseEvent<HTMLCanvasElement>) => {
    ...
    // Colapsar área
    engineRef.current.observeAt(universeX, universeY, 500);
  ...
  return (
    <div className="relative w-full h-screen bg-[#050505] text-white overflow-hidden font-mono">
      ...
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-6 z-10">
        ...
        <div className={`flex-1 flex flex-col items-center justify-center pointer-events-none transition-opacity duration-1000 ${documentaryMode ? 'opacity-30' : 'opacity-100'}`}>
